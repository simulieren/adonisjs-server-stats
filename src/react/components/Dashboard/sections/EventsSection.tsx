        ...
        <>
          <DataTable
            columns={[
              ...
              { key: 'event_name', label: 'Event', render: (v: string) => <span style={{ color: 'var(--ss-sql-color)' }}>{v}</span> },
              { key: 'data', label: 'Data', render: (v: any) => <JsonViewer data={v} maxPreviewLength={80} /> },
