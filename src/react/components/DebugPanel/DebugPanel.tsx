...
import type { DebugPanelProps as DebugPanelPropsBase, DebugTab, DebugPane } from '../../../core/types.js'
...
export function DebugPanel(props: DebugPanelProps) {
  ...
  const visibleTabs = useMemo(
    () => builtInTabs.filter((t) => t.visible),
    [builtInTabs]
  )
  ...
  const renderTabContent = useCallback(() => {
    ...
    const tabMap: Record<string, React.ReactNode> = {
      ...
      routes: <RoutesTab {...tabProps} currentPath={typeof window !== 'undefined' ? window.location.pathname : ''} />,
