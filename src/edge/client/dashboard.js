...
;(function () {
  ...
  var renderRequests = function (data) {
    ...
    var reqTable = document.querySelector('#ss-dash-requests-body .ss-dash-table')
    if (reqTable) initResizableColumns(reqTable)
  ...
  var renderQueries = function (data) {
    ...
    var qTable = document.querySelector('#ss-dash-queries-body .ss-dash-table')
  ...
  var renderQueriesGrouped = function (data) {
    ...
    html += '</tbody></table>'
    setInner('ss-dash-queries-body', html)
    var qgTable = document.querySelector('#ss-dash-queries-body .ss-dash-table')
    if (qgTable) initResizableColumns(qgTable)
  }
  ...
  var renderEvents = function (data) {
    ...
    var evTable = document.querySelector('#ss-dash-events-body .ss-dash-table')
  ...
  var renderRoutes = function (data) {
    ...
    var rtTable = document.querySelector('#ss-dash-routes-body .ss-dash-table')
  ...
  var renderEmails = function (data) {
    ...
    var emTable = document.querySelector('#ss-dash-emails-body .ss-dash-table')
  ...
  var renderTraces = function (data) {
    ...
    var tlTable = document.querySelector('#ss-dash-timeline-body .ss-dash-table')
  ...
  var renderCache = function (data) {
    ...
    var cacheTable = document.querySelector('#ss-dash-cache-body .ss-dash-table')
    if (cacheTable) initResizableColumns(cacheTable)
  ...
  var renderJobs = function (data) {
    ...
    items.forEach(function (j) {
      ...
      html +=
        ...
        esc(j.payload || j.data ? compactPreview(j.payload || j.data, 120) : '') +
        '">' +
        esc(j.payload || j.data ? compactPreview(j.payload || j.data, 60) : '-') +
        '</td>' +
        '<td style="color:var(--ss-muted);text-align:center">' +
  ...
  var renderCustomPane = function (pane) {
    ...
    var cpTable = bodyEl.querySelector('.ss-dash-table')
